        ...
        <aside class="hmm-sidebar">
            ...
            <div class="sidebar-section">
                ...
                <div class="algorithm-buttons">
                    <button class="btn btn-primary" onclick="runForward()" style="width: 100%; margin-bottom: 0.5rem;">
                        <i class="fas fa-arrow-right"></i> Forward (α)
                    </button>
                    <button class="btn btn-primary" onclick="runViterbi()" style="width: 100%; margin-bottom: 0.5rem;">
                        <i class="fas fa-route"></i> Viterbi
                    </button>
                    <button class="btn btn-secondary" onclick="runBaumWelch()" style="width: 100%;">
                        <i class="fas fa-sync"></i> Baum-Welch
                    </button>
                </div>
            </div>
        ...
        <main class="hmm-main">
            ...
            <div class="tab-content">
                ...
                <div class="tab-panel" id="tab-results">
                    ...
                    <p class="text-muted">Resultados de los algoritmos Forward, Viterbi y Baum-Welch</p>
                    
                    <div id="results-container">
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> Ejecuta un algoritmo para ver los resultados
                        </div>
                    </div>
                </div>
