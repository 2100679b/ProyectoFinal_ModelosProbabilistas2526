...
\lstdefinestyle{bashstyle}{
    ...
    keywordstyle=\color{azulclaro}\bfseries, % Usamos azulclaro o azuloscuro
    stringstyle=\color{rojoclaro},
    commentstyle=\color{verdecode}\itshape,
    xleftmargin=15pt,
    xrightmargin=5pt,
    % AGREGAR ESTA LÍNEA PARA RESALTAR COMANDOS DE GIT:
    morekeywords={git, clone, cd, php, composer} 
}
...
\begin{lstlisting}[style=bashstyle, caption={Verificación de instalaciones}]
# Verificar PHP
php -v
...
\begin{lstlisting}[style=bashstyle, caption={Clonar repositorio}]
# Clonar el proyecto
...
\begin{lstlisting}[style=bashstyle, caption={Iniciar servidor PHP}]
...
\begin{lstlisting}[style=bashstyle, caption={Instalación completa en Ubuntu}]
...
\begin{lstlisting}[style=bashstyle, caption={Instalación en macOS}]
